...
function WhatsApp() {
  ...
  if ($('#whatsapp .nama').val() == '') { // Cek Nama
    ...
    $('#whatsapp .nama').focus();
    return false;
  } else if ($('#whatsapp .umur').val() == '') { // Cek Umur
    ph = $('#whatsapp .umur').attr('placeholder');
    alert('Silahkan tulis ' + ph);
    $('#whatsapp .umur').focus();
    return false;
    ...
    var tujuan = $('#whatsapp .tujuan').val(),
      ...
      umur = $('#whatsapp .umur').val(),
      nik = $('#whatsapp .nik').val(),
      nowhatsapp = $('#whatsapp .nowhatsapp').val(),
      alamat = $('#whatsapp .alamat').val();
    $(this).attr('href', url_wa + '?phone=62 ' + tujuan + '&text=Nama: ' + nama + '%0AUmur: ' + umur + '%0ANIK: ' + nik + ' %0ANo. Whatsapp: ' + nowhatsapp + '%0AAlamat: ' + alamat + ' %0A%0Avia ' + via_url);
    var w = 960,
      h = 540,
